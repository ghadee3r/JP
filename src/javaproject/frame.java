...
public class frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setText("Enter hotel name");
        ...
        jButton3.setText("add new room OR delete a room");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Add new school
        String sizeStr , Name;
        sizeStr = jTextField1.getText();
        Name = jTextField2.getText();
        int size=0;
        try{
         size = Integer.parseInt(sizeStr);
        }catch(NumberFormatException ex){
        JOptionPane.showMessageDialog(this, "invalid size, try again");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // go to display frame
        if(ObjHotel==null){
            JOptionPane.showMessageDialog(this, "create new Hotel or load one.");
            return;
        }
        frame3 displayFrame= new frame3();
